...
<li><a href="#">Portefeuille</a>
    <div class="sub-menu-1">
        <ul>
            <li><a href="#">Donnees Personnelles</a></li>
            <li><a href="#">Mes Monnaies</a></li>
...
<main>
    ...
    <iframe  src="./Graphes/FIL30dCStick.html" width="1202" height="690" frameborder="0"></iframe>
</main>
</html>